...
const translations = {
    en: {
        ...
        "summary-text": "Business Analyst transitioning from 4+ years in software engineering (insurance, e-commerce), with a master's in Innovative Information Systems. Skilled in requirements elicitation, data modelling, stakeholder management, and data visualisation. Experienced in agile environments with strong analytical skills. Bilingual English/French (C2/B2) and open to opportunities across Europe.",
        ...
        "project-brso-d4": "Applied full MOA methodology: stakeholder mapping (Power/Interest grid), requirements elicitation, BRD → Gap Analysis → FRD traceability chain",
        ...
        "project1-detail5": "Developed KPI dashboards and analytics tools for tracking NC reports, identifying recurrence patterns, and monitoring corrective actions",
        ...
        "job1-resp4": "Performed Business Analyst responsibilities: collaborated with product owners and client SMEs to clarify scope, refine requirements, and manage backlog for insurance platform features",
